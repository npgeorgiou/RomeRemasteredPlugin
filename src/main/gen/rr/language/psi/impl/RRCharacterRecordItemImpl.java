...
public class RRCharacterRecordItemImpl extends ASTWrapperPsiElement implements RRCharacterRecordItem {

  public RRCharacterRecordItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitCharacterRecordItem(this);
  }
  ...
  @NotNull
  public RRSex getSex() {
    return findNotNullChildByClass(RRSex.class);
  }
