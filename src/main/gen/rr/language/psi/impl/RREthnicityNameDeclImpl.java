...
public class RREthnicityNameDeclImpl extends ASTWrapperPsiElement implements RREthnicityNameDecl {

  public RREthnicityNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitEthnicityNameDecl(this);
  }
