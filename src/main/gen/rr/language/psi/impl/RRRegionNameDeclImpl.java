...
public class RRRegionNameDeclImpl extends ASTWrapperPsiElement implements RRRegionNameDecl {

  public RRRegionNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitRegionNameDecl(this);
  }
