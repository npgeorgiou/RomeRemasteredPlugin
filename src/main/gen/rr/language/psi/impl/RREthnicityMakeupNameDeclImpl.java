...
public class RREthnicityMakeupNameDeclImpl extends ASTWrapperPsiElement implements RREthnicityMakeupNameDecl {

  public RREthnicityMakeupNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitEthnicityMakeupNameDecl(this);
  }
