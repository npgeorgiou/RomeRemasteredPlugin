...
public class RRBuildingLevelNameDeclImpl extends ASTWrapperPsiElement implements RRBuildingLevelNameDecl {

  public RRBuildingLevelNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitBuildingLevelNameDecl(this);
  }
