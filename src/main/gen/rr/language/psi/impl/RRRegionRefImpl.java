...
public class RRRegionRefImpl extends ASTWrapperPsiElement implements RRRegionRef {

  public RRRegionRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitRegionRef(this);
  }
  ...
  @Override
  public RegionReference getReference() {
