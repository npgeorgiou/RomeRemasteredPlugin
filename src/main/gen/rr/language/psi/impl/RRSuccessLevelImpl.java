...
public class RRSuccessLevelImpl extends ASTWrapperPsiElement implements RRSuccessLevel {

  public RRSuccessLevelImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitSuccessLevel(this);
  }
