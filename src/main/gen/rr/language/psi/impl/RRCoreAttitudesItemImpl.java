...
public class RRCoreAttitudesItemImpl extends ASTWrapperPsiElement implements RRCoreAttitudesItem {

  public RRCoreAttitudesItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitCoreAttitudesItem(this);
  }
