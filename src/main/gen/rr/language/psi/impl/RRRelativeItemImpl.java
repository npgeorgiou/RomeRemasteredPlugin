...
public class RRRelativeItemImpl extends ASTWrapperPsiElement implements RRRelativeItem {

  public RRRelativeItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitRelativeItem(this);
  }
