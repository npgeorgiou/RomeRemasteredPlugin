...
public class RRAiPersonalityNameDeclImpl extends ASTWrapperPsiElement implements RRAiPersonalityNameDecl {

  public RRAiPersonalityNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitAiPersonalityNameDecl(this);
  }
