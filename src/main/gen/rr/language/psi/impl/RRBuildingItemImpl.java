...
public class RRBuildingItemImpl extends ASTWrapperPsiElement implements RRBuildingItem {

  public RRBuildingItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitBuildingItem(this);
  }
