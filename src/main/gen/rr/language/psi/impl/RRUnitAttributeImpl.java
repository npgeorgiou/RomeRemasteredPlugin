...
public class RRUnitAttributeImpl extends ASTWrapperPsiElement implements RRUnitAttribute {

  public RRUnitAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitUnitAttribute(this);
  }
