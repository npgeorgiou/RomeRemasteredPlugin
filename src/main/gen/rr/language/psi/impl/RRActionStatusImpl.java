...
public class RRActionStatusImpl extends ASTWrapperPsiElement implements RRActionStatus {

  public RRActionStatusImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitActionStatus(this);
  }
