...
public class RRAncillaryNameDeclImpl extends ASTWrapperPsiElement implements RRAncillaryNameDecl {

  public RRAncillaryNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitAncillaryNameDecl(this);
  }
