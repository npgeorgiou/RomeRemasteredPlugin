...
public class RRResourceItemImpl extends ASTWrapperPsiElement implements RRResourceItem {

  public RRResourceItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitResourceItem(this);
  }
