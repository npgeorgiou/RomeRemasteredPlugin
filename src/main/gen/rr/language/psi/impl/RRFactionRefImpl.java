...
import rr.language.psi.references.FactionReference;

public class RRFactionRefImpl extends ASTWrapperPsiElement implements RRFactionRef {

  public RRFactionRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitFactionRef(this);
  }
  ...
  @Override
  public FactionReference getReference() {
