...
public class RRNamesNameImpl extends ASTWrapperPsiElement implements RRNamesName {

  public RRNamesNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitNamesName(this);
  }
