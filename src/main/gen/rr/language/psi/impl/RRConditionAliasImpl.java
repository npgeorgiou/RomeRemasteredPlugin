...
public class RRConditionAliasImpl extends ASTWrapperPsiElement implements RRConditionAlias {

  public RRConditionAliasImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitConditionAlias(this);
  }
