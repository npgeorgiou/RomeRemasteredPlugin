...
public class RRFactionGroupNameDeclImpl extends ASTWrapperPsiElement implements RRFactionGroupNameDecl {

  public RRFactionGroupNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitFactionGroupNameDecl(this);
  }
