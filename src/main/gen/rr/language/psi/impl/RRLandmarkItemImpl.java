...
public class RRLandmarkItemImpl extends ASTWrapperPsiElement implements RRLandmarkItem {

  public RRLandmarkItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitLandmarkItem(this);
  }
