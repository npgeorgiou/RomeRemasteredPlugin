...
public class RRKvFormatImpl extends ASTWrapperPsiElement implements RRKvFormat {

  public RRKvFormatImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitKvFormat(this);
  }
  ...
  public RRKVFItem getKVFItem() {
    return findNotNullChildByClass(RRKVFItem.class);
  }
