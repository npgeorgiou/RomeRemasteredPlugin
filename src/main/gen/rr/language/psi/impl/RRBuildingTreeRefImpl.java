...
public class RRBuildingTreeRefImpl extends ASTWrapperPsiElement implements RRBuildingTreeRef {

  public RRBuildingTreeRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitBuildingTreeRef(this);
  }
  ...
  @Override
  public BuildingTreeReference getReference() {
