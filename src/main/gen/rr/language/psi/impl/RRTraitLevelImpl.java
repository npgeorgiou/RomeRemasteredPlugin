...
public class RRTraitLevelImpl extends ASTWrapperPsiElement implements RRTraitLevel {

  public RRTraitLevelImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitTraitLevel(this);
  }
