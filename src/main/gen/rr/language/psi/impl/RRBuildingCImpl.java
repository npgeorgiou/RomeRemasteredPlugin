...
public class RRBuildingCImpl extends ASTWrapperPsiElement implements RRBuildingC {

  public RRBuildingCImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitBuildingC(this);
  }
