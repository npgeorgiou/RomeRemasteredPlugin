...
public class RRAgentTypeImpl extends ASTWrapperPsiElement implements RRAgentType {

  public RRAgentTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitAgentType(this);
  }
