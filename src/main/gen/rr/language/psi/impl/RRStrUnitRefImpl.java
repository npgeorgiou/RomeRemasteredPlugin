...
public class RRStrUnitRefImpl extends ASTWrapperPsiElement implements RRStrUnitRef {

  public RRStrUnitRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitStrUnitRef(this);
  }
  ...
  @Override
  public UnitReference getReference() {
