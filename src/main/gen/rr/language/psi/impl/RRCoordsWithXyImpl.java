...
public class RRCoordsWithXyImpl extends ASTWrapperPsiElement implements RRCoordsWithXy {

  public RRCoordsWithXyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitCoordsWithXy(this);
  }
