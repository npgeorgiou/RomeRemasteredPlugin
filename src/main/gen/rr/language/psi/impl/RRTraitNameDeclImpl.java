...
public class RRTraitNameDeclImpl extends ASTWrapperPsiElement implements RRTraitNameDecl {

  public RRTraitNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitTraitNameDecl(this);
  }
