...
public class RRCultureNameDeclImpl extends ASTWrapperPsiElement implements RRCultureNameDecl {

  public RRCultureNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitCultureNameDecl(this);
  }
