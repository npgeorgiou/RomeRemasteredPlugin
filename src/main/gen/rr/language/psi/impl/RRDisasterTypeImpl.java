...
public class RRDisasterTypeImpl extends ASTWrapperPsiElement implements RRDisasterType {

  public RRDisasterTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitDisasterType(this);
  }
