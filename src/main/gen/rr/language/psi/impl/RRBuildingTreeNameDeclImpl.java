...
public class RRBuildingTreeNameDeclImpl extends ASTWrapperPsiElement implements RRBuildingTreeNameDecl {

  public RRBuildingTreeNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitBuildingTreeNameDecl(this);
  }
