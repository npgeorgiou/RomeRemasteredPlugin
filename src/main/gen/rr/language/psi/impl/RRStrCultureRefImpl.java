...
public class RRStrCultureRefImpl extends ASTWrapperPsiElement implements RRStrCultureRef {

  public RRStrCultureRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitStrCultureRef(this);
  }
