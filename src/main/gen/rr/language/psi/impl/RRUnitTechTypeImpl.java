...
public class RRUnitTechTypeImpl extends ASTWrapperPsiElement implements RRUnitTechType {

  public RRUnitTechTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitUnitTechType(this);
  }
