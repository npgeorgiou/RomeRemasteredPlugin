...
public class RRUnitClassImpl extends ASTWrapperPsiElement implements RRUnitClass {

  public RRUnitClassImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitUnitClass(this);
  }
