...
public class RRFactionNameDeclImpl extends ASTWrapperPsiElement implements RRFactionNameDecl {

  public RRFactionNameDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitFactionNameDecl(this);
  }
