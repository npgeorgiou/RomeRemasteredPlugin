...
public class RRMountClassImpl extends ASTWrapperPsiElement implements RRMountClass {

  public RRMountClassImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitMountClass(this);
  }
