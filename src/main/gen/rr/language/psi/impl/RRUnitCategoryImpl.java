...
public class RRUnitCategoryImpl extends ASTWrapperPsiElement implements RRUnitCategory {

  public RRUnitCategoryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitUnitCategory(this);
  }
