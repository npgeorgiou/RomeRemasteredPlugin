...
public class RRConflictTypeImpl extends ASTWrapperPsiElement implements RRConflictType {

  public RRConflictTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitConflictType(this);
  }
