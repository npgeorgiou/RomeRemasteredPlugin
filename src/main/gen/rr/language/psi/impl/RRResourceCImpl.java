...
public class RRResourceCImpl extends ASTWrapperPsiElement implements RRResourceC {

  public RRResourceCImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RRVisitor visitor) {
    visitor.visitResourceC(this);
  }
